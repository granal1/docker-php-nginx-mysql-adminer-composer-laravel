# Docker PHP NGINX PMySQL Adminer Composer Laravel

Docker использует Nginx, PHP-FPM, MySQL, Composer, Adminer и Laravel.  
...
В качестве БД используется MySQL в связке с Adminer.
...
1. Загрузка из гит репозитория `git clone https://github.com/granal1/docker-php-nginx-mysql-adminer-composer-laravel.git project`  
